...
//        Log.d(TAG, "onStartCommand: " + intent.action + ", flag: " + flags + ", startId: " + startId)
        if (ScreenCaptureService.Companion.isStartCommand(intent)) {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.TIRAMISU) {
                ...
                startForeground(notification.first!!, notification.second, FOREGROUND_SERVICE_TYPE_MEDIA_PROJECTION)
            }
            // Start projection
    ...
    fun checkNoMoreDesktopTunnels() {
        ...
        if (desktopTunnelCloud == 0) {
            ...
            if (g_mainActivity != null) {
                ...
                ConnectionService.service.stopProjection()
            }
        }
    }
